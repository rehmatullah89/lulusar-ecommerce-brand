<?
	...
	***********************************************************************************************
	...
	$bError     = true;
        ...
        if($iProduct > 0)
        {
            /*$iType      = getDbValue("type_id", "tbl_products", "id='$iProduct'");
            $iCategory  = getDbValue("category_id", "tbl_products", "id='$iProduct'");
            $iCollection= getDbValue("collection_id", "tbl_products", "id='$iProduct'");
