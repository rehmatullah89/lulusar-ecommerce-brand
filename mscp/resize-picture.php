<?
	...
	***********************************************************************************************
	...
	$sFields = array(
	                  "Product"      => array("Table"     => "tbl_products",
	                                          "Field"     => "picture",
	                                          "SourceDir" => (PRODUCTS_IMG_DIR.'originals/'),
	                                          "TargetDir" => (PRODUCTS_IMG_DIR.'thumbs/'),
	                                          "Width"     => PRODUCTS_IMG_WIDTH,
	                                          "Height"    => PRODUCTS_IMG_HEIGHT),

	                  "BlogPost"     => array("Table"     => "tbl_blog_posts",
	                                          "Field"     => "picture",
	                                          "SourceDir" => (BLOG_POSTS_IMG_DIR.'originals/'),
	                                          "TargetDir" => (BLOG_POSTS_IMG_DIR.'thumbs/'),
	                                          "Width"     => BLOG_POSTS_IMG_WIDTH,
	                                          "Height"    => BLOG_POSTS_IMG_HEIGHT),
