...
?>
		  ...
		  <div class="datetime"><input type="text" name="txtStartDateTime" id="txtStartDateTime" value="<?= (($sStartDateTime == '' || $sStartDateTime == '0000-00-00 00:00:00') ? '' : $sStartDateTime) ?>" maxlength="18" size="18" class="textbox" readonly /></div>

		  <div class="br10"></div>

		  <label for="txtEndDateTime">End Date/Time <span>(Optional)</span></label>
		  <div class="datetime"><input type="text" name="txtEndDateTime" id="txtEndDateTime" value="<?= (($sEndDateTime == '' || $sEndDateTime == '0000-00-00 00:00:00') ? '' : $sEndDateTime) ?>" maxlength="18" size="18" class="textbox" readonly /></div>
