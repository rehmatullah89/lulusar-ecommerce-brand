...
?>
  <script type="text/javascript" src="scripts/<?= $sCurDir ?>/edit-promotion.js?<?= @filemtime("{$sAdminDir}scripts/{$sCurDir}/edit-promotion.js") ?>"></script>
</head>
	...
	<table border="0" cellpadding="0" cellspacing="0" width="100%">
	  <tr valign="top">
		<td width="350">
		  ...
		  <div class="datetime"><input type="text" name="txtStartDateTime" id="txtStartDateTime" value="<?= substr($sStartDateTime, 0, -3) ?>" maxlength="16" size="18" class="textbox" readonly /></div>

		  <div class="br10"></div>

		  <label for="txtEndDateTime">End Date/Time</label>
		  <div class="datetime"><input type="text" name="txtEndDateTime" id="txtEndDateTime" value="<?= substr($sEndDateTime, 0, -3) ?>" maxlength="16" size="18" class="textbox" readonly /></div>
		  ...
		  <label for="filePicture">Picture <span><?= (($sPicture == "") ? '(optional - promotional badge)' : ('(<a href="'.(SITE_URL.PROMOTIONS_IMG_DIR.$sPicture).'" class="colorbox">'.substr($sPicture, strlen("{$iPromotionId}-")).'</a> - <a href="'.$sCurDir.'/delete-promotion-picture.php?PromotionId='.$iPromotionId.'&Index='.$iIndex.'">Delete</a>)')) ?></span></label>
		  <div><input type="file" name="filePicture" id="filePicture" value="" size="30" class="textbox" /></div>
