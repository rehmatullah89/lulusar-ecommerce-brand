...
?>
  <script type="text/javascript" src="scripts/<?= $sCurDir ?>/edit-coupon.js?<?= @filemtime("{$sAdminDir}scripts/{$sCurDir}/edit-coupon.js") ?>"></script>
</head>
...
?>
  <form name="frmRecord" id="frmRecord" method="post" action="<?= @htmlentities($_SERVER['PHP_SELF'], ENT_QUOTES, 'UTF-8') ?>">
	<input type="hidden" name="CouponId" id="CouponId" value="<?= $iCouponId ?>" />
