<?
	...
	***********************************************************************************************
	...
	$iInventoryId   = IO::intValue("StockId");
	...
	$sSQL = "SELECT * FROM tbl_inventory WHERE id='$iInventoryId'";
	$objDb->query($sSQL);
...
?>
  <form name="frmRecord" id="frmRecord" method="post" action="<?= @htmlentities($_SERVER['PHP_SELF'], ENT_QUOTES, 'UTF-8') ?>" enctype="multipart/form-data">
	<input type="hidden" name="StockId" id="StockId" value="<?= $iInventoryId ?>" />        
	<input type="hidden" name="Index" value="<?= $iIndex ?>" />
	<div id="RecordMsg" class="hidden"></div>

                    <label for="txtTitle"><b>Product Name</b></label>
		    <div><?= $sTitle ?><input type="hidden" name="txtTitle" id="txtTitle" value="<?= $sTitle ?>" /><input type="hidden" name="ProductId" id="ProductId" value="<?= $iProduct ?>" /></div>
