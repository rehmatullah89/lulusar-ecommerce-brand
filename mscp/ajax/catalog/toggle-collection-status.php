<?
	...
	***********************************************************************************************
	...
	if ($iCollectionId > 0)
	{
		$sSQL = "UPDATE tbl_collections SET status=IF(status='A', 'I', 'A') WHERE id='$iCollectionId'";

		if ($objDb->execute($sSQL) == true)
			print "success|-|The selected Collection status has been Toggled successfully.";
