<?
	...
	***********************************************************************************************
	...
	@list($iTotalRecords, $iPageCount, $iStart) = getPagingInfo("tbl_inventory_history", $sConditions, $iPageSize, $iPageId);

	
	$sSQL = "SELECT *, (SELECT name from tbl_admins WHERE id=tbl_inventory_history.modified_by) as _ModifiedBy
                         FROM tbl_inventory_history $sConditions $sOrderBy LIMIT $iStart, $iPageSize";
	...
	$sOutput = array("sEcho"                => IO::intValue("sEcho"),
	                 "iTotalRecords"        => getDbValue("COUNT(1)", "tbl_inventory_history"),
