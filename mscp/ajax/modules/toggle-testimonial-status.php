<?
	...
	***********************************************************************************************
	...
	if ($iTestimonialId > 0)
	{
		$sSQL = "UPDATE tbl_testimonials SET status=IF(status='A', 'I', 'A') WHERE id='$iTestimonialId'";

		if ($objDb->execute($sSQL) == true)
			print "success|-|The selected Testimonial status has been Toggled successfully.";
