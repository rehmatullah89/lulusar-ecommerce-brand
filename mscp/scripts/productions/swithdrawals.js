...
$(document).ready(function( )
{
	$("#BtnReset").click(function( )
	{
        ...
        $("#BtnCancel2").button({ icons:{ primary:'ui-icon-refresh' } });
        $("#BtnSave").button({ icons:{ primary:'ui-icon-disk' } });
        
        $("#BtnCancel2").click(function( )
	{       
               location.href = "productions/swithdrawals.php";
               $("#RecordMsg").hide( );
               $("#txtBarCode").focus( );
	...
	{       
                ...
                if( $("#StockHistDetailId").val() == 'undefined' ||  $("#StockHistDetailId").val() == '')
                {
...
/*	$("#frmRecord").submit(function( )
        ...
        if (parseInt($("#TotalRecords").val( )) > 100)
	{
		objChargesTable = $("#ChargesGrid").dataTable({ sDom            : '<"H"f<"toolbar"><"TableTools">>t<"F"ip>',
							        ...
							        bAutoWidth      : false,
							        bServerSide     : true,
							        sAjaxSource     : "ajax/productions/get-shistory-items.php",
        ...
        $(document).on("click", "#ChargesGrid .icnDetails", function(event)
	{
		...
		$.colorbox({ href:("productions/view-swithdrawan-items-details.php?Ids=" + sWithdrawnItems + "&Index=" + iIndex), width:"800px", height:"600px", iframe:true, opacity:"0.50", overlayClose:false });
