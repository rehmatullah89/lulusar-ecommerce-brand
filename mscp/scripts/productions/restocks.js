...
$(document).ready(function( )
{
	...
	{       
               location.href = "productions/restocks.php";
               $("#RecordMsg").hide( );
               $("#txtBarCode").focus( );
...
/*	$("#frmRecord").submit(function( )
        ...
        if (parseInt($("#TotalRecords").val( )) > 100)
	{
		objChargesTable = $("#ChargesGrid").dataTable({ sDom            : '<"H"f<"toolbar"><"TableTools">>t<"F"ip>',
							        ...
							        bAutoWidth      : false,
							        bServerSide     : true,
							        sAjaxSource     : "ajax/productions/get-restock-items.php",
        ...
        $(document).on("click", "#ChargesGrid .icnDetails", function(event)
	{
		...
		$.colorbox({ href:("productions/view-restock-items-details.php?Ids=" + sWithdrawnItems + "&Index=" + iIndex), width:"800px", height:"600px", iframe:true, opacity:"0.50", overlayClose:false });
