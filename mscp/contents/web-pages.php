...
?>
  <script type="text/javascript" src="scripts/<?= $sCurDir ?>/web-pages.js?<?= @filemtime("{$sAdminDir}scripts/{$sCurDir}/web-pages.js") ?>"></script>
</head>
...
<?
	...
	for ($i = 0; $i < $iCount; $i ++)
	{
		...
		$sPlacements = str_replace("F1", "Footer (C1)", $sPlacements);
		$sPlacements = str_replace("F2", "Footer (C2)", $sPlacements);
		$sPlacements = str_replace("F3", "Footer (C3)", $sPlacements);
		$sPlacements = str_replace("F4", "Footer (C4)", $sPlacements);
		  ...
		  <form name="frmRecord" id="frmRecord" method="post" action="<?= @htmlentities($_SERVER['PHP_SELF'], ENT_QUOTES, 'UTF-8') ?>">
		    ...
		    <div class="multiSelect" style="height:auto;">
			  <table border="0" cellpadding="0" cellspacing="0" width="100%">
			    ...
			    <tr>
				  <td><input type="checkbox" name="cbPlacements[]" id="cbFooter1" value="F1" <?= ((@in_array("F1", IO::getArray('cbPlacements'))) ? 'checked' : '') ?> /></td>
				  <td><label for="cbFooter1">Footer (Column 1)</label></td>
			    </tr>
				
			    <tr>
				  <td><input type="checkbox" name="cbPlacements[]" id="cbFooter2" value="F2" <?= ((@in_array("F2", IO::getArray('cbPlacements'))) ? 'checked' : '') ?> /></td>
				  <td><label for="cbFooter2">Footer (Column 2)</label></td>
			    </tr>
				
			    <tr>
				  <td><input type="checkbox" name="cbPlacements[]" id="cbFooter3" value="F3" <?= ((@in_array("F3", IO::getArray('cbPlacements'))) ? 'checked' : '') ?> /></td>
				  <td><label for="cbFooter3">Footer (Column 3)</label></td>
			    </tr>
				
			    <tr>
				  <td><input type="checkbox" name="cbPlacements[]" id="cbFooter4" value="F4" <?= ((@in_array("F4", IO::getArray('cbPlacements'))) ? 'checked' : '') ?> /></td>
