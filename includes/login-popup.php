<?
	...
	***********************************************************************************************
	\*********************************************************************************************/
?>
<section class="popup" id="Login">
  <form name="frmPopupLogin" id="frmPopupLogin" class="frmLogin" onsubmit="return false;">
	<a href="./" class="fRight register">Not Registered? Click here</a>
	<h2>Sign in</h2>
	
	<div id="PopupLoginMsg" class="hidden"></div>
	  
	<div class="field">
	  <input type="text" name="txtEmail" id="txtPopupEmail" value="<?= $_COOKIE['CustomerEmail'] ?>" maxlength="100" class="textbox" placeholder="Email Address" />
	  <label for="txtPopupEmail"><i class="fa fa-fw fa-envelope" aria-hidden="true"></i></label>
	</div>
	
	<div class="br5"></div>
	
	<div class="field">
	  <input type="password" name="txtPassword" id="txtPopupPassword" value="<?= $_COOKIE['CustomerPassword'] ?>" maxlength="30" class="textbox" placeholder="Password" />
	  <label for="txtPopupPassword"><i class="fa fa-fw fa-lock" aria-hidden="true"></i></label>
	</div>
